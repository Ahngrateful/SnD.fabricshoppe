...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO products (product_name, category, price, quantity, roll_price, product_image) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssddis", $product_name, $category, $price, $quantity, $roll_price, $product_image);
        $stmt->execute();
