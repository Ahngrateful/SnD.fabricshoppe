...
<body>
            ...
            ?>
                <div class="categories-col">
                    <a href="dupesearchlanding.php?category=<?= urlencode($item['category']) ?>">
                        <img src="<?= htmlspecialchars($item['product_image']) ?>" alt="Fabric Image" style=" height: 400px;">
    ...
    <div class="aboutUs" style="background: linear-gradient(180deg, rgba(234,217,149,0.6694327389158788) -84%, rgba(255,255,255,0) 100%); height: auto; box-shadow: -1px -4px 5px rgba(0, 0, 0, 0.15);">
        ...
        <div class="content-abt">
            <div class="abt1">
                ...
                <cite><br>Established in 2001, our family-run business has over two decades of experience providing high-quality fabrics that cater to every style, project, and occasion. Located in the vibrant textile hub of Ilaya, Divisoria, we offer a wide range of fabrics—from timeless classics to the 
                latest trends—ensuring that our customers always find what they’re looking for.<br> Now, we’re taking a step forward by bringing our store online. This will make it easier for you to explore our products, check availability, and place orders conveniently 
                from anywhere.<br> Choose S&D Fabrics Shoppe for quality, variety, and exceptional service. Let’s create something beautiful together!
                <br><br></cite>
    ...
    <div class="available-row" style="background: linear-gradient(360deg, rgba(234,217,149,0.6694327389158788) -84%, rgba(255,255,255,0) 100%); height: 100px; box-shadow: -1px 4px 5px rgba(0, 0, 0, 0.15);"></div>
      ...
      <!--PRE-SIGN UP-->
    <div class="presignup" id="presignup">
